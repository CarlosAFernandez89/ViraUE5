...
#include "GameplayAbilityCharm_Conflagration.generated.h"

/**
 * 
 */
UCLASS()
class VIRA_API UGameplayAbilityCharm_Conflagration : public UVyraGameplayAbility_CharmBase
{
	GENERATED_BODY()

public:
	UGameplayAbilityCharm_Conflagration();
