...
void UGameplayAbility_MeleeAttack::OnGiveAbility(const FGameplayAbilityActorInfo* ActorInfo,
...
void UGameplayAbility_MeleeAttack::EndAbility(const FGameplayAbilitySpecHandle Handle,
	const FGameplayAbilityActorInfo* ActorInfo, const FGameplayAbilityActivationInfo ActivationInfo,
...
EAttackDirection UGameplayAbility_MeleeAttack::GetAttackDirection(const FVector2D& MovementInput)
{
