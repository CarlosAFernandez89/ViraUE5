...
#include "VyraCommonActivatableWidget_WithASC.generated.h"

class UGSCCoreComponent;

USTRUCT(BlueprintType)
struct FVyraGameplayEffectUIData
{
	GENERATED_BODY()
	...
	FVyraGameplayEffectUIData(const float StartTime, const float TotalDuration, const float ExpectedEndTime, const int32 StackCount, const int32 StackLimitCount)
		: StartTime(StartTime),
	...
	FVyraGameplayEffectUIData(): StartTime(0), TotalDuration(0), ExpectedEndTime(0), StackCount(0), StackLimitCount(0)
	{
	}
};
 ...
 */
UCLASS()
class VIRA_API UVyraCommonActivatableWidget_WithASC : public UCommonActivatableWidget
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintImplementableEvent, Category = "GAS Companion|UI")
	void OnGameplayEffectAdded(FGameplayTagContainer AssetTags, FGameplayTagContainer GrantedTags, FActiveGameplayEffectHandle ActiveHandle, FVyraGameplayEffectUIData EffectData);

	/** Event triggered by Companion Core Component whenever a gameplay effect is removed */
	UFUNCTION(BlueprintImplementableEvent, Category = "GAS Companion|UI")
	void OnGameplayEffectRemoved(FGameplayTagContainer AssetTags, FGameplayTagContainer GrantedTags, FActiveGameplayEffectHandle ActiveHandle, FVyraGameplayEffectUIData EffectData);
	...
	FVyraGameplayEffectUIData GetGameplayEffectUIData(FActiveGameplayEffectHandle ActiveHandle);
